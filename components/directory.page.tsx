...
const DirectoryPage: FC = () => {
    return (
        <div>
            ...
            <DirectoryItems name={'Omak David'} title={'Kagawad'} image={pic5}/>
            <DirectoryItems name={'Eddie Arinal'} title={'Kagawad'} image={pic6}/>
            </div>
            ...
            <div className={'grid grid-cols-3 justify-items-center gap-3 pl-12 pr-4'}>
                <DirectoryItems name={'Eric Bolanio'} title={'Kagawad'} image={pic7}/>
                <DirectoryItems name={'Fidel Olariz'} title={'Kagawad'} image={pic8}/>
                <DirectoryItems name={'Ryan Tamayo'} title={'Kagawad'} image={pic9}/>
            </div>
        </div>
